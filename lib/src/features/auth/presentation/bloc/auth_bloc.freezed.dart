...
abstract class $AuthEventCopyWith<$Res> {
  ...
  @useResult
  $Res call({String username, String password, VoidCallback onSuccess});
}
...
class _$LoginEventImpl implements _LoginEvent {
  ...
  @override
  String toString() {
    return 'AuthEvent.loginEvent(username: $username, password: $password, onSuccess: $onSuccess)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, username, password, onSuccess);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loginEvent(username, password, onSuccess);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loginEvent?.call(username, password, onSuccess);
  }
...
class __$$LoadingErrorImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$LoadingErrorImpl>
...
class _$LoadingErrorImpl implements _LoadingError {
  ...
  @override
  String toString() {
    return 'AuthState.loadingError(message: $message)';
  }
...
abstract class _LoadingError implements AuthState {
  const factory _LoadingError(final String message) = _$LoadingErrorImpl;
